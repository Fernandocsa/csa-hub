/**
 * Import Campeonato Alagoano 1959 (6 jogos CSA; 1 anulado).
 * - Sem técnico informado
 * - Season=1959 inclusive 2º turno mar–abr/1960
 * - Oficial (exclui anulado 16/04): J5 V3 E0 D2 GP9 GC10
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1959-alagoano.mjs";
...
const CANON = {
  ...
  "agustín farrapeira": "Augustin Ferrapeira",
};
...
const CREATE_META = {
  nivaldo: { name: "Nivaldo", position: "Zagueiro", forceCreate: true },
...
try {
  ...
  console.log("oficial esperado (exclui anulado): J5 V3 E0 D2 GP9 GC10");
  console.log("OK Alagoano 1959");
} catch (e) {
