/**
 * Apply complementary Alagoano 2001 sheets (CSA-only).
 * Usage: node scripts/apply-2001-alagoano-sheets.mjs [--dry]
 *
 * Manager: Estevam Soares only when sheet.manager is set (Finalíssima).
 */
...
import {
  ...
  SHEETS,
  RELATED_PAIRS,
} from "./data/season-2001-alagoano-sheets.mjs";
...
/** Known CSA players from nearby seasons — avoid colliding with unrelated namesakes. */
const FORCE_ID = {
  mazinho: 1013,
  "fabio magrao": 1877,
  "bruno alves": 1869,
  bruno: 1869,
  "sandro oliveira": 1905,
  sandro: 1905,
  "joao paulo": 1894,
  "fabinho silva": 1890,
  fabinho: 828,
...
const CREATE_META = {
  "luis carlos": { name: "Luís Carlos", position: "Goleiro", forceNew: true },
  "luiz carlos": { name: "Luís Carlos", position: "Goleiro", forceNew: true },
  cristiano: { name: "Cristiano", position: "Goleiro", forceNew: true },
  alex: { name: "Alex", position: "Lateral", forceNew: true },
  "alex gomes": { name: "Alex", position: "Lateral", forceNew: true },
  claudinei: { name: "Claudinei", position: "Zagueiro", forceNew: true },
  sinval: { name: "Sinval", position: "Zagueiro", forceNew: true },
  alisson: { name: "Alisson", position: "Volante", forceNew: true },
  robson: { name: "Robson", position: "Volante", forceNew: true },
  geninho: { name: "Geninho", position: "Meia", forceNew: true },
  juninho: { name: "Juninho", position: "Lateral", forceNew: true },
  fabiano: { name: "Fabiano", position: "Atacante", forceNew: true },
  toninho: { name: "Toninho", position: "Atacante", forceNew: true },
  cacapa: { name: "Caçapa", position: "Zagueiro", forceNew: true },
  "leandro gaucho": { name: "Leandro Gaúcho", position: "Zagueiro", forceNew: true },
  "leandro paulista": { name: "Leandro Paulista", position: "Zagueiro", forceNew: true },
  edmilson: { name: "Edmílson", position: "Zagueiro", forceNew: true },
};
...
try {
  ...
  // Manager season stats for Estevam if linked
  if (!DRY) {
