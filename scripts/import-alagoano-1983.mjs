/**
 * Import Campeonato Alagoano 1983 (34 jogos) + fichas/gols quando informados.
 * - CSA vice-campeão; CRB campeão dos 3 turnos e geral
 * - Técnicos: Wassil Barbosa → Ernesto Guedes → Luciano Veloso → Tadeu Lima
...
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1983-alagoano.mjs";
...
const CANON = {
  ...
  falcao: "Falcão",
  falcão: "Falcão",
  "edson silva": "Édson Silva",
  "édson silva": "Édson Silva",
  edson: "Édson Silva",
  édson: "Édson Silva",
  nei: "Ney Vagner",
  ney: "Ney Vagner",
  "nei vagner": "Ney Vagner",
  "ney vagner": "Ney Vagner",
  "ney wagner": "Ney Vagner",
  "nei wagner": "Ney Vagner",
  milton: "Mílton",
  mílton: "Mílton",
  nilson: "Nílson",
  nílson: "Nílson",
...
const CREATE_META = {
  zelito: { position: "Atacante", forceCreate: true },
  falcao: { position: "Meia", forceCreate: true },
  falcão: { position: "Meia", forceCreate: true },
  zeica: { position: "Meia", forceCreate: true },
  zeíca: { position: "Meia", forceCreate: true },
  bebeto: { position: "Atacante", forceCreate: true },
  "ney vagner": { position: "Atacante", forceCreate: true },
  milton: { position: "Lateral", forceCreate: true },
  mílton: { position: "Lateral", forceCreate: true },
  jurandir: { position: "Goleiro", forceCreate: true },
  "edson silva": { position: "Volante", forceCreate: true },
  "édson silva": { position: "Volante", forceCreate: true },
  ricardo: { position: "Lateral", forceCreate: true },
  nilson: { position: "Atacante", forceCreate: true },
  nílson: { position: "Atacante", forceCreate: true },
  ademir: { position: "Volante", forceCreate: true },
  everaldo: { position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("fonte: J34 V15 E11 D08 GP67 GC24 | PG42 (classificação com bônus dos turnos)");
  console.log("OK Alagoano 1983");
} catch (e) {
