/**
 * Import Campeonato Alagoano 1956 (9 jogos CSA; 1 sem placar).
 * Documento: "Campeonato da Capital — Edição 1956" (só Maceió) — gravado como Alagoano.
 * Sem técnico. Escalação em 1/9. Oficial com placar: J8 V5 E1 D2 GP22 GC11
 *   + 1 vitória decisão sem placar → J9 V6 E1 D2 GP22 GC11.
 * CSA campeão 1º turno; venceu decisão vs Ferroviário (campeão 2º); título alagoano 1956.
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1956-alagoano.mjs";
...
const CREATE_META = {
  eugenio: { name: "Eugênio", position: "Atacante", forceCreate: true },
  eugênio: { name: "Eugênio", position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado: J9 V6 E1 D2 GP22 GC11 (1 vitória decisão sem placar)");
  console.log("OK Alagoano 1956");
} catch (e) {
