/**
 * Import Campeonato Alagoano 1958 (6 jogos CSA; 1 sem placar).
 * Documento: "Campeonato de Futebol da Capital" (só Maceió) — gravado como Alagoano.
 * Sem técnico/escalações. Oficial com placar: J5 V3 E2 D0 GP15 GC6 (+1 unknown).
 * CSA campeão (1º e 2º turnos; FAF reconhece título estadual).
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1958-alagoano.mjs";
...
const CANON = {
  ...
  "agostin farrapeira": "Augustin Ferrapeira",
  "agostín ferrapeira": "Augustin Ferrapeira",
  "augustin ferrapeira": "Augustin Ferrapeira",
  "agustin farrapeira": "Augustin Ferrapeira",
...
try {
  ...
  console.log("oficial esperado (com placar): J5 V3 E2 D0 GP15 GC6 + 1 unknown");
  console.log("OK Alagoano 1958");
} catch (e) {
