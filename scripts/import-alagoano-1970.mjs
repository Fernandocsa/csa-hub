/**
 * Import Campeonato Alagoano 1970 (21 jogos CSA).
 * - Técnico: Maglione Sales (a partir do 2º turno)
 * - Zé Luiz goleiro: #1783 (era 1970/72 ≠ década de 80)
 * - Zé Luiz II: volante #1179 (fonte às vezes Zé Luiz / Zé Luiz I no meio)
 * - Dida: zagueiro novo (≠ Dida goleiro #782)
 * - Oficial: J21 V9 E5 D7 GP25 GC13
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1970-alagoano.mjs";
...
const FORCE_ID = {
  // Goleiro era 1970/72 — NÃO #1180/#1689 da década de 80
  "ze luiz": 1783,
  "zé luiz": 1783,
  // Volante (planilha: Zé Luiz II)
  "ze luiz ii": 1179,
  "zé luiz ii": 1179,
  "ze galego": 1176,
  "zé galego": 1176,
...
const CREATE_META = {
  // Zagueiro — ≠ Dida goleiro #782
  dida: { position: "Zagueiro", forceCreate: true },
  // ≠ Givaldo #882 (nasc. 1969)
  givaldo: { position: "Zagueiro", forceCreate: true },
  catatau: { position: "Lateral", forceCreate: true },
  sale: { position: "Meia", forceCreate: true },
  "salê": { position: "Meia", forceCreate: true },
  valfrido: { position: "Atacante", forceCreate: true },
  piranha: { position: "Atacante", forceCreate: true },
  lele: { position: "Atacante", forceCreate: true },
  lelé: { position: "Atacante", forceCreate: true },
  caroco: { position: "Meia", forceCreate: true },
  caroço: { position: "Meia", forceCreate: true },
};
...
try {
  ...
  console.log("oficial: J21 V9 E5 D7 GP25 GC13");
  console.log("OK Alagoano 1970");
} catch (e) {
