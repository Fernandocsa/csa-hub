/**
 * Import Campeonato Alagoano 1982 (36 jogos do texto) + fichas/gols quando informados.
 * - CSA campeão estadual (1º e 3º turnos + superturno)
 * - Técnicos: Jorge Vasconcelos → Velha (a partir do 3º turno)
 * - Classificação oficial: J37 E8; texto lista J36 E7 (GF/GC iguais)
 * - Gols contra: ownGoalDirection for|against + own_goals_for_count
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1982-alagoano.mjs";
...
const CANON = {
  ...
  beu: "Beu",
  béu: "Beu",
  "gaucho lima": "Gaúcho Lima",
  "gaúcho lima": "Gaúcho Lima",
  joao: "João",
  joão: "João",
};
...
const CREATE_META = {
  joceli: { position: "Goleiro", forceCreate: true },
  joao: { position: "Atacante", forceCreate: true },
  joão: { position: "Atacante", forceCreate: true },
  celso: { position: "Atacante", forceCreate: true },
  valmir: { position: "Zagueiro", forceCreate: true },
};
...
try {
  ...
  console.log(
    "fonte texto: J36 V25 E07 D04 GP78 GC23 | oficial: J37 E08 (1 empate ausente no texto)",
  );
  console.log("OK Alagoano 1982");
} catch (e) {
