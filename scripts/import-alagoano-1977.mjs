/**
 * Import Campeonato Alagoano 1977 (27 jogos CSA).
 * - Sem técnico na fonte (manager null)
 * - ASA não disputou (Fumeirão interditado)
 * - CSA 3º; CRB campeão; decisão CRB x CSE sem CSA
 * - Soma: J27 V15 E5 D7 GP47 GC24 (tabela final cita GC22)
 * - Gols contra: ownGoalDirection for|against + own_goals_for_count
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1977-alagoano.mjs";
...
const CREATE_META = {
  milano: { position: "Goleiro", forceCreate: true },
  ulisses: { position: "Zagueiro", forceCreate: true },
  enio: { position: "Lateral", forceCreate: true },
  ênio: { position: "Lateral", forceCreate: true },
  dao: { position: "Volante", forceCreate: true },
  dão: { position: "Volante", forceCreate: true },
  almiro: { position: "Lateral", forceCreate: true },
  assis: { position: "Atacante", forceCreate: true },
  "nilton melo": { position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log(
    "soma placares: J27 V15 E5 D7 GP47 GC24 | tabela final fonte GP47 GC22",
  );
  console.log("OK Alagoano 1977");
} catch (e) {
