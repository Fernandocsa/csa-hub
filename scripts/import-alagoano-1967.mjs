/**
 * Import Campeonato Alagoano 1967 (22 jogos CSA).
 * - Técnico (quando informado): Roberto Mendes (decisão 15–18/02/1968)
 * - Season=1967 inclusive 2º turno / decisão jan–fev/1968
 * - Oficial: J22 V13 E7 D2 GP44 GC17
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1967-alagoano.mjs";
...
const FORCE_ID = {
  ...
  eric: 813,
  "tonho lima": 528,
  renato: 1092, // ponta esquerda 1945
  jurinha: 950,
  irineu: 900,
};
...
const CREATE_META = {
  demazinho: { name: "Demazinho", position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado: J22 V13 E7 D2 GP44 GC17");
  console.log("OK Alagoano 1967");
} catch (e) {
