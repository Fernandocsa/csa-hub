/**
 * Apply complementary Série D 2009 sheets (CSA-only).
 * Usage: node scripts/apply-2009-seried-sheets.mjs [--dry]
 */
...
import {
  ...
  PHASE_BY_DATE,
  SHEETS,
} from "./data/season-2009-seried-sheets.mjs";
...
const FORCE_ID = {
  ...
  magno: 2020,
  "junior caicara": 2048,
  "juninho caicara": 2048,
  braun: 2039,
  braw: 2039,
  "serginho baiano": 2013,
  "marcos antonio": 78,
  "marco antonio": 78,
};

const CREATE_META = {
  jorginho: { name: "Jorginho", position: "Lateral", forceNew: true },
  "thiago messias": { name: "Thiago Messias", position: "Zagueiro", forceNew: true },
  "selmo lima": { name: "Selmo Lima", position: "Zagueiro", forceNew: true },
  fabio: { name: "Fábio", position: "Lateral", forceNew: true },
  "fabio gaucho": { name: "Fábio Gaúcho", position: "Volante", forceNew: true },
  kim: { name: "Kim", position: "Meia", forceNew: true },
  nem: { name: "Nem", position: "Meia", forceNew: true },
  gustavo: { name: "Gustavo", position: "Meia", forceNew: true },
  etinho: { name: "Etinho", position: "Atacante", forceNew: true },
  marcilio: { name: "Marcílio", position: "Meia", forceNew: true },
  heverton: { name: "Heverton", position: "Goleiro", forceNew: true },
  mica: { name: "Mica", position: "Lateral", forceNew: true },
  "victor hugo": { name: "Victor Hugo", position: "Zagueiro", forceNew: true },
  rafael: { name: "Rafael", position: "Lateral", forceNew: true },
  "anderson alagoano": {
    name: "Anderson Alagoano",
    position: "Volante",
    forceNew: true,
  },
  rinaldo: { name: "Rinaldo", position: "Atacante", forceNew: true },
  neguinho: { name: "Neguinho", position: "Atacante", forceNew: true },
  serginho: { name: "Serginho", position: "Meia", forceNew: true },
  pia: { name: "Piá", position: "Meia", forceNew: true },
  sinval: { name: "Sinval", position: "Volante", forceNew: true },
  harley: { name: "Harley", position: "Atacante", forceNew: true },
  emilio: { name: "Emílio", position: "Atacante", forceNew: true },
};

const STADIUM_META = {
  "estadio lacerdao": {
    name: "Estádio Lacerdão",
    city: "Caruaru",
    state: "PE",
  },
};
...
const STADIUM_ALIAS = {
  ...
  "estadio lacerdao": "Estádio Lacerdão",
  lacerdao: "Estádio Lacerdão",
};
