/**
 * Import Campeonato Alagoano 1978 (28 jogos CSA).
 * - Técnicos: Paulistinha → Wassil Barbosa (só a decisão 31/01/1979)
 * - CSA vice (43 PG); CRB campeão (41 PG) — critério do 0x0 não detalhado na fonte
 * - Decisão 1979-01-31 fica em season=1978
 * - Soma dos placares: J28 V18 E7 D3 GP53 GC12 (tabela final cita GP56 GC10)
 * - Gols contra: ownGoalDirection for|against + own_goals_for_count
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1978-alagoano.mjs";
...
const CANON = {
  ...
  "luis carlos felix": "Luiz Carlos Félix",
  "luís carlos félix": "Luiz Carlos Félix",
};
...
const CREATE_META = {
  ...
  válter: { position: "Volante", forceCreate: true },
  elcio: { position: "Atacante", forceCreate: true },
  élcio: { position: "Atacante", forceCreate: true },
  patota: { position: "Lateral", forceCreate: true },
  betinho: { position: "Volante", forceCreate: true },
};
...
try {
  ...
  console.log(
    "soma placares: J28 V18 E7 D3 GP53 GC12 | tabela final fonte GP56 GC10",
  );
  console.log("OK Alagoano 1978");
} catch (e) {
