/**
 * Import Campeonato Alagoano 1969 (12 jogos CSA).
 * - Técnico: Pinguela
 * - Zé Luiz / Zé Luís = volante #1179 (≠ goleiros da década de 80; ≠ #1783)
 * - Dida = zagueiro #1793 (≠ Dida goleiro #782)
 * - Oficial: J12 V6 E4 D2 GP23 GC10
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1969-alagoano.mjs";
...
const CANON = {
  ...
  "ze galego": "Zé Galego",
  "zé galego": "Zé Galego",
  // Fonte mistura Zé Luiz / Zé Luís no meio → unifica no volante
  "ze luiz": "Zé Luís",
  "zé luiz": "Zé Luís",
  "ze luis": "Zé Luís",
  "zé luís": "Zé Luís",
...
const FORCE_ID = {
  // Volante — NÃO goleiro #1783 / #1180 / #1689 / #1686
  "ze luis": 1179,
  "zé luís": 1179,
  "ze luiz": 1179,
  "zé luiz": 1179,
...
const CREATE_META = {
  edmilson: { position: "Meia", forceCreate: true },
  edmílson: { position: "Meia", forceCreate: true },
  cabeludo: { position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial: J12 V6 E4 D2 GP23 GC10");
  console.log("OK Alagoano 1969");
} catch (e) {
