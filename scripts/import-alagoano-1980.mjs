/**
 * Import Campeonato Alagoano 1980 (36 jogos) + fichas/gols quando informados.
 * - CSA campeão (1º e 2º turnos; regulamento priorizou turnos sobre PG geral)
 * - Técnicos: Laerte Dória → Tadeu Lima (02/11) → Alberto Meneses (05/11+)
 * - Soma placares texto: GF63 GC23; oficial GP66 GC20
 * - Gols contra: ownGoalDirection for|against + own_goals_for_count
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1980-alagoano.mjs";
...
const CANON = {
  ...
  leguele: "Alberto Leguelé",
  leguelé: "Alberto Leguelé",
  ...
  "alberto menezes": "Alberto Meneses",
};
...
const CREATE_META = {
  joca: { position: "Lateral", forceCreate: true },
  paulinho: { position: "Zagueiro", forceCreate: true },
  "alberto carioca": { position: "Meia", forceCreate: true },
  rogerio: { position: "Atacante", forceCreate: true },
  rogério: { position: "Atacante", forceCreate: true },
  caneta: { position: "Atacante", forceCreate: true },
  nilson: { position: "Atacante", forceCreate: true },
  nílson: { position: "Atacante", forceCreate: true },
  juremir: { position: "Goleiro", forceCreate: true },
  "jorge luiz": { position: "Meia", forceCreate: true },
  sabara: { position: "Volante", forceCreate: true },
  sabará: { position: "Volante", forceCreate: true },
  roberval: { position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log(
    "fonte texto: J36 V21 E10 D05 GP63 GC23 | oficial: GP66 GC20 (discrepância de 3 gols)",
  );
  console.log("OK Alagoano 1980");
} catch (e) {
