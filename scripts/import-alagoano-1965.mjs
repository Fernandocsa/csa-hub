/**
 * Import Campeonato Alagoano 1965 (18 jogos CSA).
 * - Técnico (quando informado): Roberto Mendes (decisão 06–13/02/1966)
 * - Season=1965 inclusive 2º turno / decisão jan–fev/1966
 * - Oficial: J18 V13 E3 D2 GP54 GC18
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1965-alagoano.mjs";
...
const CANON = {
  ...
  adonis: "Adônis",
  adônis: "Adônis",
  "ze claudio": "Zé Cláudio",
  "zé cláudio": "Zé Cláudio",
  "zé claudio": "Zé Cláudio",
  "edson matos": "Edson Tavares de Matos",
  "édson matos": "Edson Tavares de Matos",
  "edson tavares de matos": "Edson Tavares de Matos",
  "nilson silva": "Nilson Silva",
  "nílson silva": "Nilson Silva",
  "nilson ferreira da silva": "Nilson Silva",
  "roberto mendes": "Roberto Mendes",
  "sebastiao rufino": "Sebastião Rufino (PE)",
  "sebastião rufino": "Sebastião Rufino (PE)",
  "sebastiao rufino pe": "Sebastião Rufino (PE)",
  "sebastião rufino pe": "Sebastião Rufino (PE)",
};
...
const CREATE_META = {
  evilasio: { name: "Evilásio", position: "Volante", forceCreate: true },
  evilásio: { name: "Evilásio", position: "Volante", forceCreate: true },
  chico: { name: "Chico", position: "Zagueiro", forceCreate: true },
  "ze claudio": { name: "Zé Cláudio", position: "Zagueiro", forceCreate: true },
  "zé cláudio": { name: "Zé Cláudio", position: "Zagueiro", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado: J18 V13 E3 D2 GP54 GC18");
  console.log("OK Alagoano 1965");
} catch (e) {
