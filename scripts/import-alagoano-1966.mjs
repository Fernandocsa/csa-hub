/**
 * Import Campeonato Alagoano 1966 (19 jogos com dados; 1º jogo da final omitido).
 * - Técnicos: Roberto Mendes / Maglione Sales
 * - Season=1966 inclusive decisão 19/03/1967
 * - Oficial com placar: J18 V14 E3 D1 GP46 GC14 (+1 unknown Guarany; 2 W.O. 1x0)
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1966-alagoano.mjs";
...
const CANON = {
  ...
  "édson tavares matos": "Edson Tavares de Matos",
  "edson tavares matos": "Edson Tavares de Matos",
...
const CREATE_META = {
  jaldenir: { name: "Jaldenir", position: "Atacante", forceCreate: true },
  "ze hilton": { name: "Zé Hilton", position: "Atacante", forceCreate: true },
  "zé hilton": { name: "Zé Hilton", position: "Atacante", forceCreate: true },
  pedro: { name: "Pedro", position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado (com placar): J18 V14 E3 D1 GP46 GC14 + 1 unknown");
  console.log("OK Alagoano 1966");
} catch (e) {
