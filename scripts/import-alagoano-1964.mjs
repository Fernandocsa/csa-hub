/**
 * Import Campeonato Alagoano 1964 (18 jogos CSA).
 * - Técnicos: Wassil Barbosa (1º/2º turno) / Hélio Miranda (3º turno)
 * - Season=1964 inclusive 3º turno jan–fev/1965
 * - Oficial: J18 V9 E4 D5 GP39 GC26 (CSA 2º geral; CRB campeão)
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1964-alagoano.mjs";
...
const CANON = {
  ...
  "silvio mario": "Sílvio Mário",
  "sílvio mário": "Sílvio Mário",
  ...
  "alfredo santa ritta": "Alfredo Santa Rita",
  "alfredo santa rita": "Alfredo Santa Rita",
  "wassil barbosa": "Wassil Barbosa",
  "helio miranda": "Hélio Miranda",
  "hélio miranda": "Hélio Miranda",
  "olten ayres de abreu": "Olten Ayres de Abreu (PE)",
  "olten ayres de abreu pe": "Olten Ayres de Abreu (PE)",
};
...
const FORCE_ID = {
  ...
  clóvis: 526,
  pinga: 1075,
  rogerio: 1105, // atacante 1942 (lateral era)
  rogério: 1105,
  brito: 720,
  charuto: 747,
  deda: 775, // meia 1941
...
const CREATE_META = {
  "silvio mario": { name: "Sílvio Mário", position: "Volante", forceCreate: true },
  "sílvio mário": { name: "Sílvio Mário", position: "Volante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado (Alagoano): J18 V9 E4 D5 GP39 GC26");
  console.log("OK Alagoano 1964");
} catch (e) {
