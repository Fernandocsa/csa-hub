/**
 * Apply complementary Série C 2008 sheets (CSA-only).
 * Usage: node scripts/apply-2008-seriec-sheets.mjs [--dry]
 */
...
import {
  ...
  PHASE_BY_DATE,
  SHEETS,
} from "./data/season-2008-seriec-sheets.mjs";
...
const CREATE_META = {
  buiu: { name: "Buiu", position: "Lateral", forceNew: true },
  tozim: { name: "Tozim", position: "Atacante", forceNew: true },
  "anderson lobao": { name: "Anderson Lobão", position: "Atacante", forceNew: true },
  hugo: { name: "Hugo", position: "Meia", forceNew: true },
};

const STADIUM_META = {
  "estadio luiz viana filho": {
...
const STADIUM_ALIAS = {
  ...
  "estadio lomanto junior": "Estádio Lomanto Júnior",
  "estadio nelson peixoto feijo": "Estádio Nelson Peixoto Feijó",
  "estadio nelson peixoto": "Estádio Nelson Peixoto Feijó",
  "estadio lourival batista": "Estádio Lourival Batista",
  "estadio luiz viana filho": "Estádio Luiz Viana Filho",
};
