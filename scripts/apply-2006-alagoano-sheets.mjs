/**
 * Apply complementary Alagoano 2006 sheets (CSA-only).
 * Usage: node scripts/apply-2006-alagoano-sheets.mjs [--dry]
 */
...
import {
  ...
  RELATED_PAIRS,
  ATTENDANCE_CLEAR,
} from "./data/season-2006-alagoano-sheets.mjs";
...
const CREATE_META = {
  delmir: { name: "Delmir", position: "Goleiro", forceNew: true },
  vilson: { name: "Vílson", position: "Goleiro", forceNew: true },
  "beto goleiro": { name: "Beto", position: "Goleiro", forceNew: true },
  fabio: { name: "Fábio", position: "Lateral", forceNew: true },
  picoli: { name: "Pícoli", position: "Zagueiro", forceNew: true },
  alisson: { name: "Alisson", position: "Zagueiro", forceNew: true },
  alison: { name: "Alisson", position: "Zagueiro", forceNew: true },
  alysson: { name: "Alisson", position: "Zagueiro", forceNew: true },
  vilmar: { name: "Vilmar", position: "Zagueiro", forceNew: true },
  silvio: { name: "Sílvio", position: "Zagueiro", forceNew: true },
  claudio: { name: "Cláudio", position: "Lateral", forceNew: true },
  vanderson: { name: "Vânderson", position: "Lateral", forceNew: true },
  leomar: { name: "Leomar", position: "Volante", forceNew: true },
  edmilson: { name: "Edmílson", position: "Volante", forceNew: true },
  beto: { name: "Beto", position: "Meia", forceNew: true },
  goiano: { name: "Goiano", position: "Meia", forceNew: true },
  temisson: { name: "Têmisson", position: "Atacante", forceNew: true },
  gilberto: { name: "Gilberto", position: "Atacante", forceNew: true },
  "marquinhos mossoro": {
  ...
  ribamar: { name: "Ribamar", position: "Atacante", forceNew: true },
  dejames: { name: "Dejames", position: "Meia", forceNew: true },
  djames: { name: "Dejames", position: "Meia", forceNew: true },
  luciano: { name: "Luciano", position: "Lateral", forceNew: true },
  bruno: { name: "Bruno", position: "Atacante", forceNew: true },
  "edson sa": { name: "Édson Sá", position: "Meia", forceNew: true },
  arivelton: { name: "Arivélton", position: "Volante", forceNew: true },
  erivelton: { name: "Arivélton", position: "Volante", forceNew: true },
  jessui: { name: "Jessuí", position: "Atacante", forceNew: true },
  emerson: { name: "Émerson", position: "Atacante", forceNew: true },
  jean: { name: "Jean", position: "Volante", forceNew: true },
  lamar: { name: "Lamar", position: "Volante", forceNew: true },
  alex: { name: "Alex", position: "Meia", forceNew: true },
  jackson: { name: "Jackson", position: "Volante", forceNew: true },
  warley: { name: "Warley", position: "Atacante", forceNew: true },
  "ricardo boiadeiro": {
    name: "Ricardo Boiadeiro",
    position: "Atacante",
    forceNew: true,
  },
  mineiro: { name: "Mineiro", position: "Zagueiro", forceNew: true },
  leandro: { name: "Leandro", position: "Lateral", forceNew: true },
  ivan: { name: "Ivan", position: "Meia", forceNew: true },
  junior: { name: "Júnior", position: "Zagueiro", forceNew: true },
  jeferson: { name: "Jéferson", position: "Volante", forceNew: true },
  teo: { name: "Teo", position: "Meia", forceNew: true },
  "joao alves": { name: "João Alves", position: "Atacante", forceNew: true },
};

const STADIUM_META = {
  "estadio gerson amaral": {
    name: "Estádio Gerson Amaral",
    city: "Coruripe",
    state: "AL",
  },
  "estadio nelson peixoto feijo": {
    name: "Estádio Nelson Peixoto Feijó",
    city: "Maceió",
    state: "AL",
  },
};
...
const STADIUM_ALIAS = {
  ...
  "estadio nelson peixoto nelson": "Estádio Nelson Peixoto Feijó",
  "estadio gerson amaral": "Estádio Gerson Amaral",
  "coaracy da mata fumeirao": "Coaracy da Mata (Fumeirão)",
  "estadio coaracy da mata fonseca": "Coaracy da Mata (Fumeirão)",
...
async function ensureCsaPlayer(raw) {
  ...
  if (key === "beto goleiro") playerCache.set("beto goleiro", rows[0]);
  return rows[0];
}
