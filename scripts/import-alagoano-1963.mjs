/**
 * Import Campeonato Alagoano 1963 (19 jogos CSA).
 * - Técnico (quando informado): Pinguela (25/08/1963)
 * - Season=1963 inclusive 2ª fase / 2º turno / decisão jan–abr/1964
 * - Oficial: J19 V11 E4 D4 GP44 GC25 (CSA campeão geral)
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1963-alagoano.mjs";
...
const CANON = {
  ...
  "louraber monteiro": "Louraber Monteiro",
  "louraber monteiro ce": "Louraber Monteiro (CE)",
  "louraber monteiro pe": "Louraber Monteiro (PE)",
  "manoel correia lima": "Manoel Correia Lima (PE)",
  "manoel correia lima pe": "Manoel Correia Lima (PE)",
  "bernardes torres": "Bernardes Torres (PE)",
  "bernardes torres pe": "Bernardes Torres (PE)",
...
const FORCE_ID = {
  ...
  rogério: 1105,
  charuto: 747,
  deda: 775, // meia 1941 (quando só "Deda")
  "deda ii": 775,
  "deda i": 774, // zagueiro 1923
  ba: 691,
  bá: 691,
  marinho: 997,
  chico: 2189, // zagueiro era 1963–65
  "ze claudio": 2191,
  "zé cláudio": 2191,
};
...
const CREATE_META = {
  ademir: { name: "Ademir", position: "Goleiro", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado (Alagoano): J19 V11 E4 D4 GP44 GC25");
  console.log("OK Alagoano 1963");
} catch (e) {
