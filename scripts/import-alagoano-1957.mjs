/**
 * Import Campeonato Alagoano 1957 (8 jogos CSA).
 * Documento: "Campeonato de Futebol da Capital" (só Maceió) — gravado como Alagoano.
 * Sem técnico. Escalação em 6/8. Oficial: J8 V6 E2 D0 GP32 GC10.
 * CSA campeão 1º e 2º turnos; texto conclui título alagoano 1957 (CRB vice).
 * Amistosos CSA×Ipanema omitidos (sem data).
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1957-alagoano.mjs";
...
const CANON = {
  ...
  clovis: "Clóvis",
  clóvis: "Clóvis",
  "biu wilson": "Bil Wilson",
  "bil wilson": "Bil Wilson",
  "valfrido vieira": "Walfrido Vieira",
  "walfrido vieira": "Walfrido Vieira",
  "waldomiro breda": "Waldomiro Breda",
  "waldemiro breda": "Waldomiro Breda",
  "jose v sarmento": "José V. Sarmento",
  "josé v sarmento": "José V. Sarmento",
...
const FORCE_ID = {
  ...
  neu: 1042,
  orizon: 1051,
  tadeu: 1126, // b1932 (não #1127 b1945)
  piolho: 1076,
  deda: 775, // meia (consistente com 1959–60)
  juca: 946,
  geo: 862, // b1934
  "bil wilson": 2206,
};
...
const CREATE_META = {
  gedir: { name: "Gedir", position: "Meia", forceCreate: true },
  perereca: { name: "Perereca", position: "Atacante", forceCreate: true },
  oscarzinho: { name: "Oscarzinho", position: "Meia", forceCreate: true },
  davino: { name: "Davino", position: "Atacante", forceCreate: true },
  moura: { name: "Moura", position: "Meia", forceCreate: true },
  // Gol 13/10 sem escalação — não mapear a Paulo Santos/Patriota
  paulo: { name: "Paulo", position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado: J8 V6 E2 D0 GP32 GC10");
  console.log("OK Alagoano 1957");
} catch (e) {
