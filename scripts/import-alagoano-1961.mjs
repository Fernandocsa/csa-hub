/**
 * Import Campeonato Alagoano 1961 (8 jogos CSA).
 * - Sem técnico informado na fonte
 * - Tapetão: 10/09 CSA 2x0 CRB (campo) revertido pelo TJD/AL em 02/12 (3x2 pró CRB)
 * - Placar de campo mantido; nota no data file
 * - Campo (sem aplicar reversão): J8 V6 E1 D1 GP19 GC7
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1961-alagoano.mjs";
...
const CANON = {
  ...
  "haroldo castelo branco": "Castelo Branco",
  jernand: "Gernand",
  gernand: "Gernand",
  tonho: "Tonho",
  "tonho lima": "Tonho",
  patriota: "Paulo Patriota",
  paulo: "Paulo Patriota",
  "paulo patriota": "Paulo Patriota",
  italo: "Ítalo",
  ítalo: "Ítalo",
...
/** IDs alinhados à Taça Brasil 1961 (mesma temporada). */
const FORCE_ID = {
  lula: 972,
  "ze luiz": 1181,
  "zé luiz": 1181,
...
const CREATE_META = {
  // Sem vínculo claro com os vários "Carlinhos" do cadastro — cria perfil da era 1961
  carlinhos: { name: "Carlinhos", position: "Meia", forceCreate: true },
};
...
try {
  ...
  console.log("campo esperado (Alagoano, sem aplicar reversão TJD): J8 V6 E1 D1 GP19 GC7");
  console.log("nota: 10/09 CSA 2x0 CRB mantido em campo; TJD/AL reverteu pontos ao CRB");
  console.log("OK Alagoano 1961");
} catch (e) {
