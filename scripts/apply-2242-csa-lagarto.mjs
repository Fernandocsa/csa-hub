/**
 * Apply Série D #2242 CSA 2x0 Lagarto (2026-06-27) from user sumula.
 * Rei Pelé; referee Paulo Henrique Schleich Volfopf / Vollkopf.
 */
...
try {
  ...
  const referee = await ensureReferee("Paulo Henrique Vollkopf");
  ...
  const cards = [
    { id: 432, name: "Camacho", type: "yellow", minute: 3, injury: null },
    {
      id: 464,
      name: "Dudu Figueiredo",
      type: "yellow",
      minute: 39,
      injury: null,
    },
    ...
    { id: 476, name: "Lucas Lima", type: "yellow", minute: 86, injury: null },
  ];
