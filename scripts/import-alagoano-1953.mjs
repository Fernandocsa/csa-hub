/**
 * Import Campeonato Alagoano 1953 (16 jogos CSA — chave Clubes de Maceió).
 * Sem técnico. CSA campeão do 2º turno; Ferroviário campeão da capital;
 * ASA campeão estadual (Ferroviário recusou decisão).
 * Oficial: J16 V9 E1 D6 GP43 GC26.
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1953-alagoano.mjs";
...
const CANON = {
  ...
  edgard: "Edgar",
  edgar: "Edgar",
  "hildebrando coda": "Hildebrando Codá",
  "hildebrando codá": "Hildebrando Codá",
...
const FORCE_ID = {
  ...
  gedir: 2210,
  king: 522,
  dida: 521, // atacante b1934
  geo: 862, // b1934
  deda: 775, // meia (consistente com temporadas seguintes)
  arestides: 2221,
  zanelio: 2222,
  zanélio: 2222,
  napoleao: 2223,
  ...
  edgard: 2225,
  berenaldo: 2227,
  paulo: 2229, // zagueiro era (não atacante #2212)
  cao: 2230,
  cão: 2230,
};
...
const CREATE_META = {
  zequinha: { name: "Zequinha", position: "Goleiro", forceCreate: true },
  levino: { name: "Levino", position: "Goleiro", forceCreate: true },
  "pedro branco": { name: "Pedro Branco", position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial esperado: J16 V9 E1 D6 GP43 GC26");
  console.log("OK Alagoano 1953");
} catch (e) {
