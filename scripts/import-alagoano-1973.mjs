/**
 * Import Campeonato Alagoano 1973 (24 jogos CSA).
 * - CSA vice; CRB campeão (venceu decisão 12/08)
 * - Técnico: Maglione Sales
 * - Oficial: J24 V13 E8 D3 GP38 GC17
 */
import { loadEnvFromDotenv, createPgPool } from "./_load-env.mjs";
import { COMPETITION_NAME, SEASON, GAMES } from "./data/season-1973-alagoano.mjs";
...
const CANON = {
  ...
  "luís mario": "Luís Mário",
  "luís mário": "Luís Mário",
  "luiz mario": "Luís Mário",
  "luiz mário": "Luís Mário",
  batore: "Batoré",
  batoré: "Batoré",
  soareste: "Soareste",
...
const CREATE_META = {
  jaminho: { position: "Lateral", forceCreate: true },
  dudu: { position: "Meia", forceCreate: true },
  beto: { position: "Atacante", forceCreate: true },
  fernando: { position: "Zagueiro", forceCreate: true },
  luiz: { position: "Atacante", forceCreate: true },
};
...
try {
  ...
  console.log("oficial: J24 V13 E8 D3 GP38 GC17 | CSA vice; CRB campeão");
  console.log("OK Alagoano 1973");
} catch (e) {
