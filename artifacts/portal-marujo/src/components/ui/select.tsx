...
>(({ className, children, position = "popper", onWheel, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      onWheel={(e) => {
        // Keep wheel scroll on the dropdown — parent page scrollables otherwise steal it.
        e.stopPropagation()
        onWheel?.(e)
      }}
      {...props}
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1 max-h-[min(22rem,var(--radix-select-content-available-height))] overflow-y-auto overscroll-contain",
          position === "popper" &&
