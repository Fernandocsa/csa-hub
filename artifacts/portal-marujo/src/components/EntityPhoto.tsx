...
type PhotoShape = "circle" | "rounded";
...
/**
 * Entity profile photo with initials fallback when URL is missing or fails to load.
 * Use shape="circle" for people; shape="rounded" for stadiums.
 */
export function EntityPhoto({
  ...
  shape?: PhotoShape;
  className?: string;
  /** Used in aria-label, e.g. "Foto do técnico". */
  label?: string;
}) {
