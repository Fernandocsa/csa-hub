      ...
      <div className="flex items-start justify-between gap-3 mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Datas duplicadas e partidas sem resultado — abra a ficha para corrigir manualmente.
          </p>
        </div>
      ...
      <div className="flex gap-1 mb-5 border-b">
        ...
        >
          ...
          <span className="ml-1.5 text-xs text-gray-400">
            ({hide1920s ? visibleGroups.length : dupMeta.totalGroups})
          </span>
        </button>
        <button
          type="button"
        ...
        >
          Sem resultado
          <span className="ml-1.5 text-xs text-gray-400">({unknown.length})</span>
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div>
          <p className="text-sm text-gray-500 mb-4">
            Mesmo critério do portal público (<code className="text-xs bg-gray-100 px-1 rounded">result = unknown</code>
            , excluindo WO e amistosos). Clique para abrir a ficha e completar o placar.
          </p>
          {unknown.length === 0 ? (
            <div className="bg-white border rounded-lg px-4 py-10 text-center text-sm text-gray-400">
              Nenhuma partida sem resultado.
            </div>
          ) : (
