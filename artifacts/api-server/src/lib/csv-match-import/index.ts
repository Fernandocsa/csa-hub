...
import { yearsForPlayers, yearsForManagers } from "./entity-years";
import type { NameConflict, NameResolution } from "./types";

export type { NameConflict, NameResolution } from "./types";
export { yearsForPlayers, yearsForManagers } from "./entity-years";
