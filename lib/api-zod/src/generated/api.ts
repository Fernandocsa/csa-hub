...
export const GetSummaryResponse = zod.object({
  ...
  "nationalityFlag": zod.string().nullish().describe('Legacy emoji or code for nationality flag display'),
  "photoUrl": zod.string().nullish().describe('Player profile photo URL'),
